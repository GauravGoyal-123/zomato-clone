...
import LeftArrow from '../../commom/carousal/leftArrow';
import RightArrow from '../../commom/carousal/rightArrow';
  ...
  return (
    <div className='delivery-collection'>
        <div className='max-width'>
            <div className='collection-title'>East what makes you happy</div>
            <Slider {...settings}>
